...
export class Menu extends React.Component<MenuProps, MenuState> {
  ...
  public render(): JSX.Element {
    ...
    const trigger = this.props.children.find(
    ...
    return (
      ...
      >
        ...
        <div
          className="menu"
          tabIndex={0}
          ref={ref => this.props.isOpen && ref && ref.focus()}
          onBlur={() => this.props.close && this.props.close()}
          style={{
  ...
  get xPos(): number {
    ...
    const rightPos =
      (this.ref && this.ref.getBoundingClientRect().left) ||
      0 + this.state.width;

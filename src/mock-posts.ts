...
export default <Post[]>[
  {
    id: "foo",
    title: "Test 1",
    created: new Date(2018, 0, 1, 12, 0).toJSON(),
    lastModified: new Date(2018, 0, 1, 12, 0).toJSON(),
    markdownText: "Test",
    tags: ["awesome", "test"]
  },
  {
    id: "bar",
    title: "Test 2",
    created: new Date(2017, 11, 30, 4, 0).toJSON(),
    lastModified: new Date(2018, 0, 5, 12, 0).toJSON(),
  ...
  },
  {
    id: "foobar",
    title: "Test 3",
    created: new Date(2017, 11, 29, 18, 0).toJSON(),
    lastModified: new Date(2017, 11, 29, 18, 0).toJSON(),
    markdownText: stripIndent`
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vitae quam cursus,
    vestibulum risus id, mollis neque. Nam sit amet consequat sapien. In ornare lectus in
    purus semper interdum. Morbi aliquam ligula id ex ornare, nec ultrices nulla volutpat.
